        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-gray-900/50 border border-pink-900/30 rounded-lg p-4 sm:p-6">
              ...
              <p className="text-gray-300">
                Share a memorable three-word string like <code className="text-pink-400 bg-gray-950 px-2 py-1 rounded">happy-sunset-ocean</code> that users can connect with connection and NAT traversal is transparently handled. Support for UPnP, WebRTC, and mDNS.
              </p>
            </div>
